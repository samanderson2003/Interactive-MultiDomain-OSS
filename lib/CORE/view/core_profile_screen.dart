...
import '../controller/core_profile_controller.dart';
import '../model/core_profile_model.dart';
import '../../auth/controller/auth_controller.dart';
import '../../utils/constants.dart';

class CoreProfileScreen extends StatefulWidget {
  const CoreProfileScreen({super.key});

  @override
  State<CoreProfileScreen> createState() => _CoreProfileScreenState();
}

class _CoreProfileScreenState extends State<CoreProfileScreen> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (authController.currentUser != null) {
        context.read<CoreProfileController>().loadUserProfile(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CoreProfileController>(
  ...
  Widget _buildEmploymentInfo(UserProfile profile) {
    return FadeInUp(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.work, 'Department', 'CORE Network Engineering'),
          ],
        ),
      ),
    );
  ...
  Widget _buildPermissions(UserProfile profile) {
    return FadeInUp(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                context.read<CoreProfileController>().clearProfile();
                if (context.mounted) {
